  ...
  return (
    <div className="min-h-screen flex flex-col pb-28 sm:pb-40 text-slate-100">
      ...
      <main className="relative z-10 flex-grow container mx-auto px-4 py-8 sm:py-12 pt-40 sm:pt-48 space-y-20 md:space-y-40">
        ...
        <section className="animate-fade-in-up grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6" style={{ animationDelay: '0.2s' }}>
          <a 
            href="https://www.viralagenda.com/pt/porto/amarante" 
            target="_blank" 
            rel="noopener noreferrer"
            className="group relative overflow-hidden glass-card rounded-3xl md:rounded-[2.5rem] p-6 sm:p-10 transition-all"
          >
      ...
      <footer className="relative z-10 py-12 sm:py-20 border-t border-white/[0.05] text-center mt-20 sm:mt-40">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl sm:text-3xl font-brand font-black text-white tracking-tighter mb-2">Web Rádio Figueiró<span className="text-blue-600">.</span></h2>
          <p className="font-black uppercase tracking-[0.4em] text-[8px] sm:text-[10px] text-slate-500 mb-6 sm:mb-8">Amarante • Portugal</p>
          <div className="inline-block px-6 sm:px-8 py-2 sm:py-3 bg-white/[0.03] border border-white/[0.1] rounded-full">
            <p className="text-[8px] sm:text-[10px] font-bold text-slate-400 tracking-[0.2em]">WEBRADIOFIGUEIRO@GMAIL.COM</p>
          </div>
        </div>
      </footer>
