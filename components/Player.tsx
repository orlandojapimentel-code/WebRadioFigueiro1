    ...
    <div className="fixed bottom-0 left-0 right-0 z-[100] transition-all duration-500">
      ...
      <div className="relative bg-gray-900/95 border-t border-blue-500/20 backdrop-blur-2xl p-4 md:p-5 shadow-[0_-15px_50px_rgba(0,0,0,0.8)]">
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-4 md:gap-6">
          ...
          <div className="flex flex-col items-center md:items-end space-y-2 w-full md:w-56 px-4 md:px-0">
            <div className="flex items-center space-x-3 w-full max-w-[200px] md:max-w-none">
              <button 
                onClick={toggleMute}
                className="text-blue-500/50 hover:text-blue-400 transition-colors focus:outline-none"
              ...
              <div className="relative w-full h-1.5 bg-gray-800 rounded-full overflow-hidden border border-white/5">
                <input 
                  type="range" 
                  min="0" 
                  max="1" 
