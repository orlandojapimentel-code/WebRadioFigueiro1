...
const GeminiAssistant: React.FC = () => {
  ...
  const sendToWhatsApp = () => {
    // Busca a última mensagem do utilizador para enviar
  ...
  return (
    <div className="bg-gray-950/95 rounded-[2.5rem] border border-indigo-500/30 overflow-hidden flex flex-col shadow-[0_0_60px_rgba(79,70,229,0.15)] h-[580px] backdrop-blur-xl relative z-[60]">
      ...
      <div className="flex-grow overflow-y-auto p-5 space-y-4 scrollbar-hide bg-black/20">
        ...
        {/* Botão de Envio para o DJ - Apenas no final da conversa */}
        {hasUserMessages && !isTyping && !streamingText && (
          <div className="flex justify-center pt-4 pb-2 animate-in fade-in zoom-in duration-300">
            <button 
              ...
              className="flex items-center space-x-3 px-8 py-3 bg-green-600 hover:bg-green-500 text-white rounded-2xl text-[10px] font-black uppercase tracking-[0.15em] transition-all border border-green-400 shadow-[0_10px_30px_rgba(22,163,74,0.3)] active:scale-95 transform hover:-translate-y-0.5"
            >
              ...
              <span>Enviar Pedido p/ o DJ</span>
            </button>
          </div>
        )}
