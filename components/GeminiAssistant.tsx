        ...
        {hasUserMessages && !isTyping && !streamingText && (
          <div className="flex justify-center pt-4 pb-2 animate-in fade-in zoom-in duration-300">
            <button 
              ...
              className="flex items-center space-x-3 px-8 py-3 bg-green-600 hover:bg-green-500 text-white rounded-2xl text-[10px] font-black uppercase tracking-[0.15em] transition-all border border-green-400 shadow-[0_10px_30px_rgba(22,163,74,0.3)]"
            >
