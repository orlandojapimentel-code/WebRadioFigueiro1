...
const RecentTracks: React.FC = () => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800/40 p-6 rounded-[2.5rem] border border-gray-200 dark:border-blue-500/20 shadow-xl dark:shadow-2xl backdrop-blur-xl space-y-4 transition-colors">
      <div className="flex items-center justify-between border-b border-gray-100 dark:border-white/5 pb-4">
        <div className="flex items-center space-x-3">
          <div className="p-2.5 bg-blue-600/10 dark:bg-blue-600/20 rounded-xl text-blue-600 dark:text-blue-400">
          ...
          <div>
            ...
            <p className="text-[9px] text-blue-600 dark:text-blue-400/60 font-bold uppercase tracking-tighter mt-1">Recent Tracks</p>
          </div>
        </div>
      ...
      <div className="max-h-[320px] overflow-y-auto scrollbar-hide pr-1 min-h-[100px]">
        <div className="cc_recenttracks_list" data-username="orlando">
          <div className="flex flex-col items-center justify-center py-12 space-y-4 opacity-40">
            ...
            <p className="text-[10px] font-black uppercase tracking-[0.2em] text-center dark:text-white">Carregando ...</p>
          </div>
        </div>
      </div>
      
      <div className="pt-2 flex items-center justify-center space-x-2 border-t border-gray-100 dark:border-white/5 mt-2">
