    ...
    <header className="sticky top-0 z-50 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-b border-gray-200 dark:border-white/10 transition-colors duration-500">
      <div className="container mx-auto px-4 h-20 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3 cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
          <div className="h-10 w-10 md:h-12 md:w-12 rounded-full border-2 border-blue-500 p-0.5 overflow-hidden bg-gray-100 dark:bg-gray-800 flex items-center justify-center shadow-lg shadow-blue-500/10 dark:shadow-blue-500/20 flex-shrink-0">
            {!imgError ? (
              <img 
                src={logoPath} 
          ...
          <div className="hidden sm:block">
            <h1 className="text-lg md:text-xl font-bold tracking-tight text-slate-900 dark:text-white leading-none transition-colors">Web Rádio Figueiró</h1>
        ...
        <div className="flex items-center space-x-2 md:space-x-6">
          ...
          {/* BOTÃO SWITCH TEMA: SEMPRE VISÍVEL (MOBILE E PC) */}
          <button 
